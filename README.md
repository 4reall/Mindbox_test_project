...
## Сложности возникшие при выполнении
  1. ~~Скорее всего выбрал не самый оптимальный вариант для подсчета активных задач. Не уверен, что стоит заносить их в редюсер.~~ (**решено путем изменения изменения алгоритма расчета значения. Теперь при определенных действиях значение либо уменьшается, либо увеличивается на единицу**)
